...
현재 공개 화면은 제작자 소개, YouTube, Telemera 게임 소개, 스크롤 아래 미공개 수신실로 구성됩니다. `content/site.json`에서 사이트 이름과 유튜브 주소를 설정합니다. 기존 맵과 퍼즐은 유예되어 공개 경로에서 로드하지 않습니다. 상세 사항: `docs/site-relaunch.md`.

아래는 보관 중인 이전 구현의 기록입니다.
